...
#if !defined(DYNAMICSHADOWPROJECTOR_ENABLECBUFFER_CGINC_DEFINED)
#define DYNAMICSHADOWPROJECTOR_ENABLECBUFFER_CGINC_DEFINED
...
#endif // !defined(DYNAMICSHADOWPROJECTOR_ENABLECBUFFER_CGINC_DEFINED)
